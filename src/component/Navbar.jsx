        ...
        <div className="hidden md:flex items-center space-x-40 text-purple-900 font-medium">
          <a href="#" className="hover:text-purple-600">Home</a>
            ...
            <div className="absolute left-0 mt-3 w-56 rounded-xl bg-white shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transform scale-95 group-hover:scale-100 transition-all duration-200 ease-out z-50">
               ...
               {[
  { label: 'Shirts', id: 'categories' },
  { label: 'Skirts', id: 'categories' },
  { label: 'Frocks', id: 'categories' },
  { label: 'P.T. T-shirts', id: 'categories' },
  { label: 'P.T. Shorts', id: 'categories' },
  { label: 'P.T. Track Pants', id: 'categories' },
  { label: 'Belts', id: 'categories' },
  { label: 'Ties', id: 'categories' },
  { label: 'Logos', id: 'categories' },
  { label: 'Socks', id: 'categories' },
].map(({ label, id }) => (
  <li key={id}>
    <a
      href={`#${id}`}
